...
help:
	@echo "BlessedCJ Auto - Automotive Business Platform"
	@echo ""
...
install: ## Install and setup application
	...
	@echo "\n✅ BlessedCJ Auto installed! Access at http://localhost:8080"
...
mysql: ## Open MySQL CLI
	docker compose exec mysql mysql -u blessedcjauto -psecret blessedcjauto
